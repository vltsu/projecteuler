...
class Solution {
  ...
  public static Integer greatestProduct() {
    Integer[][] data = readDataFromFile();
  ...
  public static Integer[][] readDataFromFile() {
    BufferedReader br = null;
    String[] stringNumbers = new String[20]; 
    ...
    try {
      ...
      while (line != null) {
        ...
        for(int k = 0; k < 20; k++) {
          result[i][k] = Integer.parseInt(stringNumbers[k]);
        }
        line = br.readLine();
        i++;
      }
